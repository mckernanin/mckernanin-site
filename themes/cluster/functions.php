...
function stag_enqueue_scripts(){
  if ( ! is_admin() ) {
    ...
    wp_register_script( 'jplayer', $protocol . '//cdnjs.cloudflare.com/ajax/libs/jplayer/2.6.0/jquery.jplayer.min.js', array('jquery'), '2.6.0', true );
    ...
    wp_register_script( 'fitvids', $protocol . '//cdnjs.cloudflare.com/ajax/libs/fitvids/1.1.0/jquery.fitvids.min.js', array('jquery'), '1.1.0', true );
    wp_register_script( 'isotope', $protocol . '//cdnjs.cloudflare.com/ajax/libs/jquery.isotope/1.5.25/jquery.isotope.min.js', array('jquery'), '1.5.25', true );
